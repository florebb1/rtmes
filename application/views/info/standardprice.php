        	...
        	<tbody>
                ...
                <tr>
                	...
                	<?php for($j=0; $j<count($item); $j++){
                	    ...
                	    ?>
                   	<td>
                   		<input type="text" class="form-control standard_price_id" name="standard[<?php echo $customer[$i]["customer_id"]?>][<?php echo $item[$j]["item_id"]?>]" value="<?php echo $val;?>" style="text-align: right;">
                   	</td>
                   	<?php }?>
                </tr>
                <?php }?>
...
$("#reg_btn").on("click",function(){
	$.ajax({
        url: '/info/standardprice/edit',
        type: 'post',
        data: $('.item_id,.customer_id, .standard_price_id'),
        dataType: 'json',
        beforeSend: function() {
