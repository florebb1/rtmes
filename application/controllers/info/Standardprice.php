...
class Standardprice extends CI_Controller {
	...
	{   
	    ...
	    $data["list"] = $this->standard->getStandardPriceList();
	    $this->load->view('info/standardprice',$data);
	}
	...
	public function edit(){
	    ...
	    $result= $this->standard->insertStandardPrice($regr);
